<%@ page import="com.onb.SchoolRegistrationSystem.Course" %>
...
<div class="fieldcontain ${hasErrors(bean: courseInstance, field: 'subjects', 'error')} ">
	...
	<g:select name="subjects" from="${com.onb.SchoolRegistrationSystem.Subject.list()}" multiple="multiple" optionKey="id" size="5" value="${courseInstance?.subjects*.id}" class="many-to-many"/>
</div>
